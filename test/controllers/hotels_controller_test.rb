...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { code: @hotel.code, description: @hotel.description, hotel_type_id: @hotel.hotel_type_id, name: @hotel.name } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { code: @hotel.code, description: @hotel.description, hotel_type_id: @hotel.hotel_type_id, name: @hotel.name } }
